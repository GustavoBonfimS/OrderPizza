...
namespace OrderPizza
{
    public partial class frmCardapio : Form
    {
        ...
        private void checkedDoces_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void pizzaDoce_Click(object sender, EventArgs e)
        {

        }

        private void buttonMinimizarC_Click(object sender, EventArgs e)
        {
            this.WindowState = FormWindowState.Minimized;
        }
    }
